 ...
 * Use the {@link Tvtop_Rated#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Tvtop_Rated extends Fragment {
     ...
     * @return A new instance of fragment Tvtop_Rated.
     */
    // TODO: Rename and change types and number of parameters
    public static Tvtop_Rated newInstance(String param1, String param2) {
        Tvtop_Rated fragment = new Tvtop_Rated();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v=inflater.inflate(R.layout.fragment_tvtop__rated, container, false);
        mRecycler= (RecyclerView) v.findViewById(R.id.tvtop_rated_recycler);
        resource=R.layout.fragment_tvtop_rated_layout;
        imageresource=R.id.tvtop_rated_layout_poster;
    ...
    private void Sendjsonrequest(int page) {
        mEndpoint= Endpoint.TV+"top_rated"+"?page="+page+"&api_key="+ MyApplication.TMDB_API_KEY;
