 ...
 * Use the {@link Tvon_The_Air#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Tvon_The_Air extends Fragment {
     ...
     * @return A new instance of fragment Tvon_The_Air.
     */
    // TODO: Rename and change types and number of parameters
    public static Tvon_The_Air newInstance(String param1, String param2) {
        Tvon_The_Air fragment = new Tvon_The_Air();
    ...
    private void Sendjsonrequest(int page) {
        mEndpoint= Endpoint.TV+"on_the_air"+"?page="+page+"&api_key="+ MyApplication.TMDB_API_KEY;
