...
import info.sajib.moviesapp.adapter.Mainadapter2;
...
public class Upcomingmovie extends AppCompatActivity {
    ...
    private ArrayList<Push> pushnotify = new ArrayList<>();
    private int i = 1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.addOnItemTouchListener(new RecyclerViewTouchListner(this, recyclerView, new ClickListner() {
            ...
            public void OnClick(View v, int Position) {
                ...
                long id = movie.getId();
                Intent intent = new Intent(Upcomingmovie.this, DescriptionActivity.class);
    ...
    private void sendJsonRequest(int mCurrentPage) {
        mEndpoint = Endpoint.MOVIE + "upcoming" + "?page=" + mCurrentPage + "&api_key=" + MyApplication.TMDB_API_KEY + "&language=en";
        ...
        requestQueue.getCache().invalidate(mEndpoint, true);
